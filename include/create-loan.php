...
<table class="table">
    ...
    foreach ($loans as $loan) {
        $update_href = "/inventory/database/update-loans-tab.php?id=".$loan["id"];
        $delete_href = "/inventory/database/delete-loans-tab.php?id=".$loan["id"];
        echo
            '<tr>
            ...
            <td>' . $loan["color"] . '</td>
             <td>
             <a href='.$update_href.' class="update-loan">Update</a>
